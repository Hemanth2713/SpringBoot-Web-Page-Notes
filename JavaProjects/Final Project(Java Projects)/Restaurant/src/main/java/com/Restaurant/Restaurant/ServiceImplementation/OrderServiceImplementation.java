...
public class OrderServiceImplementation implements OrderService {
    ...
    public String placeOrder(OrderRequestDTO orderRequestDTO) {
        ...
        Address address = addressRepository.findById(orderRequestDTO.getAddressId())
                .orElseThrow(() -> new RuntimeException("Address not found with ID: " + orderRequestDTO.getAddressId()));
        ...
        // Prepare OrderItems
        List<OrderItem> orderItems = orderRequestDTO.getOrderItems().stream().map(item -> {
            MenuItem menuItem = menuItemRepository.findById(item.getItemId())
                    .orElseThrow(() -> new RuntimeException("Menu Item not found with ID: " + item.getItemId()));
        ...
        // Save OrderItems and calculate total
        ...
        return "Order placed successfully with Order ID: " + savedOrder.getOrderId();
    }
    @Override
