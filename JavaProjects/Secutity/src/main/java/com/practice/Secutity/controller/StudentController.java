...
import com.practice.Secutity.model.Student;
...
public class StudentController {
    List<Student> students=new ArrayList<>(List.of(
            new Student(101,"Sai","Java"),
            new Student(102,"Hemanth","SpringBoot"),
            new Student(103,"Durga","Python"),
            new Student(104,"Raj","SQL")
    ));
