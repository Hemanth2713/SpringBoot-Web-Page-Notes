...
public class OrdersUpdated {
    ...
    // Add username and restaurant name directly to the model
    @Transient
    ...
    // Method to set username and restaurant name (based on the associated user and restaurant)
    @PostLoad
    public void setAdditionalFields() {
        if (this.user != null) {
            this.username = this.user.getUserName(); // Assuming User class has a getUsername() method
        }
        if (this.restaurant != null) {
            this.restaurantName = this.restaurant.getRestaurantName(); // Assuming Restaurant class has a getRestaurantName() method
        }
    }

    // Getters and setters for username and restaurantName
    ...
    // Existing getters and setters for other fields (e.g., orderId, user, restaurant, etc.)
